...
namespace FractalPlotter.Graphics
{
    ...
    class ImGuiTexture : IDisposable
    {
        ...
        public void SetAnisotropy(float level)
        {
            ...
            GL.TextureParameter(GLTexture, TEXTURE_MAX_ANISOTROPY, clamp(level, 1, MaxAniso));
        }
